...
function BottomHeaderComponent() {
    return (
        <div className='flex flex-col md:flex-row items-center justify-between w-full mt-16 lg:px-10'>
            ...
            <div id="HEADER__CONTENT" className='md:basis-1/2 px-10 flex items-center flex-col'>
                ...
                <div id="HEADER___BUTTONS" className='flex items-center justify-center md:justify-start md:self-start mt-6 gap-4'>
