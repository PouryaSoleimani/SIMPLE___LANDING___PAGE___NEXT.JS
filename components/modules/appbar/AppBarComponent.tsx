...
function AppBarComponent() {
    return (
        <nav className='w-full h-auto flex items-center justify-between pr-3 pl-2 py-2 sticky top-2 left-0 bg-transparent rounded backdrop-blur-2xl border border-slate-200 z-50'>
